...
<body>
    <main>
        <img src="/images/Logo SPD.png" alt="Logo SPD">
        <p>Bengkel spesialis Speedometer Mobil. Menerima Custom (Modifikasi) dan Service (Reparasi) Speedometer Mobil.<br>Apapun Merek Speedometernya, SPD Solusinya!</p>
        <div class="container">
            <a href="https://spdspeedometer.com/" target="_blank" class="button-primary">
        ...
        <div class="grid-container">
                    ...
                    <div class="grid-cabang">
                        ...
                        <div class="button-container">
                            <a href="https://wa.me/{{ $cabang->no_whatsapp }}" target="_blank" class="button-hijau">
                                <img src="/images/Icon WA.png" alt="WA" class="icon-WA">
                                 WA
                            </a>
                            <a href="{{ $cabang->maps_link }}" target="_blank" class="button-biru">
                                <img src="/images/Icon Gmaps.png" alt="Gmaps" class="icon-Maps">
                                 Maps
                            </a>
                        </div>
                    </div>
            ...
            <div class="grid-section">
                ...
                <div class="grid-item">
                    ...
                    <a href="https://tiktok.com/@spdspeedometer/" target="_blank" class="button-hitam">Tiktok</a>
                    <a href="https://vt.tiktok.com/ZSMCwTFYN/?page=Mall/" target="_blank" class="button-hitam">Tiktok Shop</a>
                </div>
    ...
    <div class="popup-overlay" id="popup-form">
        <div class="popup">
            ...
            <p class="diskon">dapetin kupon diskon untuk custom atau service speedometer mobil kamu</p>
            <form action="{{ route('pesan.kirim') }}" method="POST">
                ...
                <label for="merk_mobil"><input type="text" id="merk_mobil" name="merk_mobil" placeholder="Merk Mobil" required></label>
